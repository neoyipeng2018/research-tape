...
has  "email link"      ">email<"
has  "email link carries the feed, so no list lives here" \
  "feedrabbit.com/subscriptions/new?url=https://neoyipeng2018.github.io/research-tape/feed.xml"
